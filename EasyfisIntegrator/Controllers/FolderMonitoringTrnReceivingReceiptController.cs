...
namespace EasyfisIntegrator.Controllers
{
    class FolderMonitoringTrnReceivingReceiptController
    {
                                        ...
                                        try
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (count == receivingReceipts.Count())
                                                {
                                                    ...
                                                    String apiURL = domain + "/api/folderMonitoring/journal/" + jDate + "/RR";
        ...
        public Task<String> DeleteTemporaryReceivingReceipt(String domain)
        {
            try
            {
                String apiURL = domain + "/api/folderMonitoring/receivingReceipt/temporary/delete";
        ...
        public Task<String> InsertTemporaryReceivingReceipt(String domain, String json)
        {
            try
            {
                String apiURL = domain + "/api/folderMonitoring/receivingReceipt/temporary/insert";
        ...
        public Task<String> PostReceivingReceipt(String domain, String branchCode, String manualRRNumber)
        {
            try
            {
                String apiURL = domain + "/api/folderMonitoring/receivingReceipt/post";
        ...
        // ============================
        // Delete All Receiving Receipt
        // ============================
        public async void DeleteAllReceivingReceipt(Forms.TrnIntegrationForm trnIntegrationForm, String domain, String currentDate)
        {
            trnIntegrationForm.folderMonitoringLogMessages("\r\n\nDeleting Receiving Receipt... (0%) \r\n\n");
            try
            {
                String deleteUploadedReceivingReceiptTask = await DeleteUploadedReceivingReceipt(domain, currentDate);
                if (!deleteUploadedReceivingReceiptTask.Equals("Delete Successful..."))
                {
                    trnIntegrationForm.folderMonitoringLogMessages(deleteUploadedReceivingReceiptTask);
                    trnIntegrationForm.folderMonitoringLogMessages("Time Stamp: " + DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss tt") + "\r\n\n");
                    trnIntegrationForm.folderMonitoringLogMessages("\r\n\n");
                }
                else
                {
                    ...
                    trnIntegrationForm.folderMonitoringLogMessages("\r\n\nDeleting Receiving Receipt... (100%) \r\n\n");
                    trnIntegrationForm.folderMonitoringLogMessages("Clean Successful!" + "\r\n\n");
                    trnIntegrationForm.folderMonitoringLogMessages("Time Stamp: " + DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss tt") + "\r\n\n");
                    trnIntegrationForm.folderMonitoringLogMessages("\r\n\n");
                }
        ...
        // =================================
        // Delete Uploaded Receiving Receipt
        // =================================
        public Task<String> DeleteUploadedReceivingReceipt(String domain, String currentDate)
        {
            try
            {
                String apiURL = domain + "/api/folderMonitoring/receivingReceipt/uploaded/delete/" + currentDate;
